    ...
    <>
                  ...
                  className={cn(
                    ...
                    link.label === "FIES"
                      ? cn(
                          ...
                          scrolled ? "bg-[#E8F0FF] text-[#0052FF]" : "bg-white/20 text-white backdrop-blur-sm"
                        )
                      : cn(
                          "font-medium",
                          scrolled ? "text-gray-600 hover:text-[#0052FF]" : "text-white/90 hover:text-white"
                        )
                  )}
                >
                  {link.label}
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className={cn(
                  ...
                  scrolled
                    ? "bg-[#0052FF] text-white hover:bg-[#003BCC] shadow-lg shadow-blue-200"
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <div className="mb-8">
              <Image src="/images/logo-flf.png" alt="FLF" width={140} height={40} className="h-10 w-auto" />
            </div>
            <nav className="flex flex-col gap-1">
              {links.map((link, i) => (
                <motion.a
                  ...
                  className={cn(
                    ...
                    link.label === "FIES" ? "text-[#0052FF] font-bold" : "text-gray-800 font-medium hover:text-[#0052FF]"
                  )}
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  {link.label}
              ...
              <motion.a
                ...
                onClick={() => setMenuOpen(false)}
                className="mt-6 w-full py-4 bg-[#0052FF] text-white text-center rounded-xl font-bold text-lg"
              >
                Garanta sua Vaga →
              </motion.a>
            </nav>
